            ...
            <div className="px-5 pt-4 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <button
                        ...
                        className="h-11 bg-white/5 border border-white/10 rounded-xl text-[11px] font-black uppercase tracking-widest flex items-center justify-center gap-2 active:bg-white/10 transition-colors"
                    >
